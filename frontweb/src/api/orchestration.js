...
export const orchestrationAPI = {
  ...
  mediaToolOptions(params = {}) { return request.get('/media-tool-options', { params, suppressGlobalError: true }) },
  mediaToolOption(id) { return request.get(`/media-tool-options/${encodeURIComponent(id)}`, { suppressGlobalError: true }) },
  experiences(params = {}) { return request.get('/media-experiences', { params, suppressGlobalError: true }) },
  experience(id) { return request.get(`/media-experiences/${encodeURIComponent(id)}`, { suppressGlobalError: true }) },
  recordExperience(body) { return request.post('/media-experiences', body, { suppressGlobalError: true }) },
  localMediaJobs(sessionId) { return request.get('/local-media/jobs', { params: { session_id: sessionId }, suppressGlobalError: true }) },
  localMediaJob(jobId) { return request.get(`/local-media/jobs/${encodeURIComponent(jobId)}`, { suppressGlobalError: true }) },
  runLocalMedia(body) { return request.post('/local-media/jobs', body) },
  resumeLocalMedia(jobId) { return request.post(`/local-media/jobs/${encodeURIComponent(jobId)}/resume`, {}) },
  ...
  openDirectory(id) { return request.post(`/orchestration-sessions/${encodeURIComponent(id)}/open-directory`, {}, { suppressGlobalError: true }) },
