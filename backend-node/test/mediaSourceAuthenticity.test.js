...
const FFMPEG = process.env.YINZI_TEST_FFMPEG || installed?.executables?.ffmpeg || getFfmpegPath();
const FFPROBE = process.env.YINZI_TEST_FFPROBE || installed?.executables?.ffprobe || getFfprobePath();
