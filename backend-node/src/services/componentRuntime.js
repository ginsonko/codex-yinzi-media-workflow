...
}),require('./skyModelManifest').SKY_COMPONENT_DEFINITION,require('./faceModelManifest').FACE_COMPONENT_DEFINITION,require('./whisperModelManifest').WHISPER_COMPONENT_DEFINITION,require('./foregroundModelManifest').FOREGROUND_COMPONENT_DEFINITION,require('./mediaDownloadManifest').YT_DLP_COMPONENT_DEFINITION,require('./rifeModelManifest').RIFE_COMPONENT_DEFINITION].map(definition => {
