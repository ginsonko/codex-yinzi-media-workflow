// ADE20K 150-class names used by SegFormer / MIT SceneParse150.
// Sky is class 2. This table is the offline fallback when config.id2label is absent.
const ADE20K_ID2LABEL = {
...
module.exports = { ADE20K_ID2LABEL, VOC_ID2LABEL };
