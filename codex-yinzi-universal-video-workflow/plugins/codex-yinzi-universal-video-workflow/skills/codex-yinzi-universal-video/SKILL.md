...
For lyrics, sung songs, rap or bilingual music, use the sibling [song creation Skill](../yinzi-music-creation/SKILL.md). Inspect hardware before local model installation and distinguish YuE2 singing from MusicGen instrumental music and TTS narration. For performance-led MV/PV, read [story and compositing](references/music-mv-story-and-compositing.md); for animation-to-live-action or frozen acting, read [live-action performance](references/live-action-character-performance.md).
